...
lib.ssMetadata = [
		{name:"SISMO_atlas_1", frames: [[569,361,46,30],[368,699,143,35],[368,736,143,35],[0,0,616,359],[569,486,314,545],[618,0,444,484],[0,919,401,105],[0,361,567,336],[0,699,366,218]]},
		{name:"SISMO_atlas_2", frames: [[0,0,931,1104],[0,1106,912,845],[933,976,996,807],[933,0,1009,974]]},
		{name:"SISMO_atlas_3", frames: [[1095,774,876,692],[1110,1468,890,510],[858,0,874,772],[0,0,856,817],[0,819,1093,595],[0,1468,1108,490]]}
];
...
(lib.CachedBmp_15 = function() {
	this.initialize(ss["SISMO_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_13 = function() {
	this.initialize(ss["SISMO_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_7 = function() {
	this.initialize(ss["SISMO_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib._8c59e65697cbeef05eb1e2496953478e = function() {
	this.initialize(ss["SISMO_atlas_1"]);
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
...
(lib.MacawBlue = function(mode,startPosition,loop,reversed) {
...
p.nominalBounds = new cjs.Rectangle(9.8,0,554,728.1);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("AAAKAIAAz/");
...
p.nominalBounds = new cjs.Rectangle(-1,-65,2,130);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-243.1,-366.5,1.5484,1.345);
...
p.nominalBounds = new cjs.Rectangle(-243.1,-366.5,486.2,733);


// stage content:
(lib.SISMO = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(406.8,332.9,720.8,745.6);
// library properties:
lib.properties = {
	id: '1EBB65E037BC774BAD8BBC2689491144',
	width: 1024,
	height: 768,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/SISMO_atlas_1.png?1614441877046", id:"SISMO_atlas_1"},
		{src:"images/SISMO_atlas_2.png?1614441877046", id:"SISMO_atlas_2"},
		{src:"images/SISMO_atlas_3.png?1614441877046", id:"SISMO_atlas_3"}
	],
	preloads: []
};
...
an.compositions['1EBB65E037BC774BAD8BBC2689491144'] = {
